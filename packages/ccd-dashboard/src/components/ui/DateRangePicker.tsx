...
export function DateRangePicker({ value, onChange }: DateRangePickerProps) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg p-4 w-72">
          <div className="mb-4">
            ...
            <div className="flex flex-col gap-1">
              {presets.map((preset) => (
                <button
                  ...
                  className="text-sm text-left px-3 py-2 rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  {preset.label}
                </button>
              ))}
          ...
          <div className="border-t pt-4">
            ...
            <div className="flex flex-col gap-2">
              <div>
                <label htmlFor="date-from" className="text-xs text-gray-500 mb-1 block">From</label>
                <input
                  id="date-from"
                  type="date"
              ...
              <div>
                <label htmlFor="date-to" className="text-xs text-gray-500 mb-1 block">To</label>
                <input
                  id="date-to"
                  type="date"
